        ...
        <div className="flex flex-wrap md:text-left text-center order-first">
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <div className="flex justify-center md:justify-start">
              <a href="https://www.instagram.com/sentirsebien_spa/" className="text-gray-600 hover:text-gray-800">
              ...
              <a href="https://www.facebook.com/profile.php?id=61565586311256" className="text-gray-600 hover:text-gray-800">
